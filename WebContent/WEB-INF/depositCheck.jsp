...
<form class="form-horizontal" method="post" action="createFund.do">
   ...
   <c:forEach items="${check}" var="checks">
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <input type="text" class="form-control" id="customerID" value="${checks.customerID}" >
            </div>
        </div>
        <div class="form-group">
            <label for="inputfirstname" class="col-lg-4 control-label">Check:</label>
            <div class="col-lg-5">
                <input type="text" class="form-control" id="check" value="${checks.cash}"  >
            </div>
        </div>
        </c:forEach>
    </fieldset>
